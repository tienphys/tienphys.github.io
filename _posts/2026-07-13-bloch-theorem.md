...
We introduce the *discrete translation operator* $\hat T_a: x\to x+a$; this is motivated by the translation symmetry properties of the particle's potential. One can check that the discrete translation operator commutes with the total Hamiltonian, $[\hat T_a, H]=0$

<details class="spoiler" markdown="1">
<summary>Show derivation</summary>

Here's how we show they commute. Math works fine in here: $[\hat T_a,\hat H]=0$.
